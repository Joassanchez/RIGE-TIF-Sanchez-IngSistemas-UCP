...
> Plantilla oficial migrada desde `catedra/plantillas/03_Plantillas_Instrumentos_AE2.docx`. Completar sobre esta estructura; `/exportar instrumento 33` genera el `.docx`.
